      ...
      !resetMode?(
        React.createElement(React.Fragment,null,
          ...
          React.createElement("div",{style:{marginBottom:14}},
            ...
            React.createElement("input",{type:"email",value:email,onChange:e=>{setEmail(e.target.value);setError("");},onFocus:()=>setFocused("email"),onBlur:()=>setFocused(""),onKeyDown:e=>{if(e.key==="Enter")handleLogin();},placeholder:"seu@email.com",style:{background:focused==="email"?"rgba(29,209,161,0.06)":"rgba(255,255,255,0.05)",border:"1px solid "+(focused==="email"?"rgba(29,209,161,0.5)":"rgba(255,255,255,0.1)"),borderRadius:12,padding:"12px 16px",color:"#e4f5f0",fontSize:14,width:"100%",outline:"none",transition:"all 0.2s"}})
          ),
